...
export const loadBaseLayers = async (map: any, _isCleanAndQuietMode?: boolean) => {
    ...
    // Load sound areas
    await loadGeoJsonFeatureCollections(
        map,
        soundPropertyKey,
        'https://alversjomaps.vercel.app/geoapi/maps/map2?features=polygons',
        {
    ...
    await loadGeoJsonFeatureCollections(
        map,
        'type',
        'https://alversjomaps.vercel.app/geoapi/maps/map2?features=points',
        {
    ...
    await addPointsOfInterestsTomap(
        'https://alversjomaps.vercel.app/geoapi/maps/map2?features=points',
        map.groups.soundspots,
        {
